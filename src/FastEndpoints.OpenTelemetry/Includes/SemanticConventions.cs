...
namespace OpenTelemetry.Trace
{
    ...
    internal static class SemanticConventions
    {
        ...
        public const string AttributeFastEndpointsValidationFailures = "fastendpoints.validation_failures";
        public const string AttributeFastEndpointsRoutes = "fastendpoints.routes";
        public const string AttributeFastEndpointsVerbs = "fastendpoints.verbs";
        public const string AttributeFastEndpointsSummary = "fastendpoints.summary";
        public const string AttributeFastEndpointsDescription = "fastendpoints.description";
        public const string AttributeFastEndpointsTags = "fastendpoints.tags";
    }
}
